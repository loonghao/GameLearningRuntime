...
即使二进制已是最新版，`glr update` 仍会从校验后的 Release 压缩包同步已配置的项目 Skills。
...
jobs:
  quality:
    uses: loonghao/GameLearningRuntime/.github/workflows/reusable-python-ci.yml@v0.23.0 # x-release-please-version
    with:
